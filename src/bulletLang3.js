...
// 2021/09/16/AM 00:49
// さてと。
// まず、描画については渡されたグラフィックに描画するように変更。
// Systemのメソッドを追加してプレイヤー以外のUnitがすべて消えたらクリアのフラグを出すようにする
// 逆にプレイヤーが消えたらゲームオーバーですね
// とりあえずそのくらいかな・・

// CrossReferenceArrayを改良して引数取れるようにしました。(argsと...を使う)
// これでgrを渡してそこに描画できるようになったはずです。

// playerをキーで動かすことについてはSceneがplayのときしかプレイヤーがいないので特に問題ないはず。
// だからplaySceneでのキー入力についてはポーズだけかな・・コントロールキーでやろうかな。
// クリックは使わないので無しで。
